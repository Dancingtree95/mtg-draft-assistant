...
if __name__ == '__main__':
    ...
    train_data.rename(columns = {'pack_cards' : 'candidates'}, inplace=True)
    save_on_disc(train_data, os.path.join(DRAFT_DATA_FOLDER_PATH, expansion + '_train_eval'), ['candidates', 'pool_cards'])
    train_data.rename(columns = {'candidates' : 'pack_cards'}, inplace=True)
